...
M-Commander è un file manager a due pannelli in modalità testo per sistemi
operativi di tipo Unix, basato su GNU Midnight Commander. Il nucleo è piccolo e
i componenti aggiuntivi dei pannelli vengono caricati durante l'esecuzione, per
cui un archivio, un sistema remoto o lo stato di un repository si gestiscono in
un pannello come file qualsiasi. I comandi girano in un terminale incorporato,
e con il programma arrivano un editor con evidenziazione della sintassi e un
visualizzatore che legge anche i file binari.
