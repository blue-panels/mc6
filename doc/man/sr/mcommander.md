...
показивач над највишим редом на екрану. Трака менија садржи шест менија:
„Лево“, „Датотека“, „Атрибути“, „Наредба“, „Опције“ и „Десно“.
...
[Мени „Атрибути“](#attributes-menu)
садржи наредбе које мењају дозволе, власника и атрибуте система датотека истих
датотека.
...
## Мени „Атрибути“ <a id="attributes-menu"></a>

Наредбе овог менија не мењају садржај датотеке, већ оно што о њој зна систем
датотека: дозволе приступа, власника и групу и атрибуте система датотека.
Свака од њих ради над изабраном датотеком, или над означеним датотекама ако их
има.

**Промена дозвола... (C-x c)**
: Мења дозволе приступа у дијалогу
[Промена дозвола](#chmod).

**Промена власника... (C-x o)**
: Мења власника и групу у дијалогу
[Промена власника](#chown).

**Напредна промена власника...**
: Мења дозволе, власника и групу у једном дијалогу, видите
[Напредна промена власника](#advanced-chown).

**Промена атрибута... (C-x e)**
: Мења атрибуте система датотека ext2, ext3 или ext4 у дијалогу
[Промена атрибута](#chattr). Ставка постоји само ако је програм изграђен са
подршком за те атрибуте.
...
Наредба
**Уреди датотеку са групама за истицање**
отвара датотеку која говори које називе и које врсте датотека панел приказује
којом бојом, видите
...
наниже од курсора и означава најближи погодак; Alt-s поново означава следећи
испод, а иза најновијег реда претрага прелази на најстарији. Тамо где куца
љуска још ништа није прочитано, па претрага узима испис од најстаријег реда.
Филтер приказује само редове који одговарају, а стрелице се крећу кроз њих
још док се образац куца; Alt-Shift-s поново помера курсор на ред испод.
Подешавање
*search_direction*
обрће оба, и претрага иде навише, као што тражи
**less**
и као што је било раније. Притиснути без укуцаног
...
приказ на нађеном, заједно са ознаком; Esc га завршава и враћа приказ какав
је био пре куцања: курсор тамо где се читало, или на упит ако се ништа није
читало, и филтер и ознаку какви су били. Сваки други тастер завршава куцање
и ради оно што иначе ради.
...
Подешавања терминала у коме иза панела ради љуска налазе се у одељку
[Terminal] исте датотеке. Ниједан прозор их не уписује.

*search_direction*
: На коју страну
**Alt-s**
претражује испис љуске и на коју
**Alt-Shift-s**
прелази са једног реда филтера на следећи: "down" иде од курсора ка
најновијем реду, а иза њега се враћа на најстарији, "up" иде ка најстаријем
реду и враћа се на најновији, као што тражи
**less**
и као што је било раније. Подразумевано је "down".
...
# ПРОМЕНЉИВЕ ОКРУЖЕЊА <a id="environment"></a>

Испод су наведене променљиве које M-Commander чита и оне које поставља за
програме које покреће. Променљиве попут **TERM**, **SHELL**, **HOME** или
**PATH** овде се не наводе: програм их чита да би сазнао где ради, а не да би
се њима подешавао.

## Читају се при покретању <a id="read-at-start-up"></a>

**MC_DATADIR**
: Директоријум из ког се узимају датотеке података, уместо уграђеног.
Погледајте [ДАТОТЕКЕ](#files).

**MC_PROFILE_ROOT**
: Корен корисничких датотека, као апсолутна путања. Погледајте
[ДАТОТЕКЕ](#files).

**MC_SKIN**
: Скин који се користи, по имену или по путањи. Погледајте [Скинови](#skins).

**MC_KEYMAP**
: Датотека распореда пречица. Погледајте [Пречице](#keys).

**MC_TMPDIR**
: Директоријум привремених датотека програма.

**MC_NO_LUA**
: Вредност 1 покреће програм без Lua извршног окружења. Ниједан Lua пакет се
не учитава и ништа што га захтева није доступно.

**MC_SIXEL**
: Вредност 0 говори да терминал нема sixel графику, а 1 да је има. Без
променљиве пита се сам терминал.

**KEYBOARD_KEY_TIMEOUT_US**
: Колико чекати остатак излазног низа, у микросекундама.

**COLORTERM**
: Чита се при избору боја. Погледајте [Боје](#colors).

**CDPATH**
: Директоријуми у којима тражи уграђена наредба cd.

**EDITOR**, **VIEWER**, **PAGER**
: Спољашњи програми који се користе када су уграђени уређивач или прегледач
искључени. Погледајте
[Параметри спољашњег уређивача или прегледача](#parameters-for-external-editor-or-viewer).

## Постављају се за програме које M-Commander покреће <a id="set-for-the-programs-m-commander-starts"></a>

Нису намењене ручном постављању. Програм их уписује да би сопствена копија
покренута из уграђеног терминала знала да већ ради унутар једног.

**MC_SID**
: Сесија у којој програм ради. Копија покренута из те сесије не отвара
сопствене панеле.

**MC_PID**
: Идентификатор процеса програма који ради.

**MC_TTY**
: Терминал на коме је програм покренут.

## Дневници за отклањање грешака <a id="debug-logs"></a>

Дневник се уписује само када је укључен, а прекидач узима вредност 1.
Променљиве прикључака враћају се на опште, па постављање само општег пара
бележи све.

**MC_LOG_ENABLE**, **MC_LOG_FILE**
: Општи дневник. Без **MC_LOG_FILE** користи се датотека наведена у *logfile*
одељка *[Logging]* датотеке *ini*, а без тог уноса *mc.log* поред осталих
корисничких датотека.

**MC_FTP_LOG_ENABLE**, **MC_FTP_LOG_FILE**
: Дневник ftp панелног прикључка. Датотека се враћа на */tmp/mc-ftp.log*.

**MC_SMB_LOG_ENABLE**, **MC_SMB_LOG_FILE**
: Дневник samba панелног прикључка. Датотека се враћа на */tmp/mc-samba.log*.

**MC_SPELL_LOG**
: Датотека у коју пише провера правописа. Нема сопствени прекидач: дневник се
уписује када променљива именује датотеку.

Да бисте сачували дневник неуспешне ftp везе:
