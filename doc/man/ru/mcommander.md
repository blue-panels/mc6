...
Этот пункт меню управляет настройками
[виртуальных файловых систем](#virtual-file-system).

В диалоге одна настройка,
*Тайм-аут освобождения ВФС,*
и это время жизни кэша файловой системы: после выхода из архива или сжатого
файла прочитанный список и распакованный временный файл держатся ещё столько
секунд, чтобы повторный вход был мгновенным, а по истечении времени
освобождаются. По умолчанию 60 секунд, 0 освобождает сразу.
...
освобождаются. По умолчанию 60; 0 освобождает сразу. Тот же параметр меняет
диалог "Виртуальные файловые системы" меню "Настройки".
