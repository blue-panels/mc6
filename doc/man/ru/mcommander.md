...
M-Commander - это двухпанельный файловый менеджер для текстового режима в
UNIX-подобных операционных системах, основанный на GNU Midnight Commander.
Ядро у него небольшое, а панельные плагины загружаются во время работы,
поэтому архив, удалённая система или состояние репозитория открываются в
панели и обрабатываются как обычные файлы. Команды выполняются во встроенном
терминале, а в комплекте идут редактор с подсветкой синтаксиса и программа
просмотра, читающая в том числе двоичные файлы.
