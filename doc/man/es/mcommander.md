...
M-Commander es un gestor de archivos de dos paneles en modo texto para
sistemas operativos tipo Unix, basado en GNU Midnight Commander. Su núcleo es
pequeño y carga sus complementos de panel en tiempo de ejecución, de modo que
un archivo comprimido, un sistema remoto o el estado de un repositorio se
manejan en un panel como archivos corrientes. Las órdenes se ejecutan en un
terminal incorporado, y el programa trae un editor con resaltado de sintaxis y
un visor que lee también archivos binarios.
