...
A M-Commander kétpaneles, szöveges módú fájlkezelő Unix típusú operációs
rendszerekhez, a GNU Midnight Commanderre épülve. Magja kicsi, a panel
bővítményeit futás közben tölti be, így egy archívum, egy távoli gép vagy egy
verziókezelt könyvtár állapota a panelben ugyanúgy kezelhető, mint a közönséges
fájlok. A parancsok beépített terminálban futnak, és a programhoz
szintaxiskiemelő szerkesztő és bináris fájlokat is olvasó megjelenítő tartozik.
