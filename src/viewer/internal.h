...
struct WView
{
    ...
    gboolean embedded;   // A cell of a screen: no frame, no status line
    ...
    mcview_state_machine_t
        dpy_state_top;  // Parser-formatter state at the topmost visible line in wrap mode
    mcview_state_machine_t
        dpy_state_bottom;     // Parser-formatter state after the bottomvisible line in wrap mode
