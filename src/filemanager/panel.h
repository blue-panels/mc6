...
/* A plugin panel temporarily hidden behind a streamed input consumer.  Its
   ...
   They nest: an archive inside an archive suspends one of these in turn. */
typedef struct
{
...
gboolean panel_plugin_activate_stream_consumer (WPanel *panel, const char *display_name,
                                                mc_pp_input_stream_t *stream);
