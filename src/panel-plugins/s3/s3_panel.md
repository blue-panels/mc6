...
```
  ...
  F7         - create bucket (at bucket level) or directory prefix
...
```
  ...
  Secret Key        - S3 secret access key (stored encoded in config)

  Region            - AWS region, e.g. us-east-1, eu-west-1
                      Default: us-east-1

  Endpoint URL      - custom S3-compatible endpoint URL
                      Required for MinIO, Ceph, Cloudflare R2, etc.
                      Leave empty for Amazon AWS.
                      Example: https://ACCOUNT_ID.r2.cloudflarestorage.com

  Buckets           - comma-separated list of bucket names
                      When set, the plugin uses this list instead of
                      querying the server for available buckets.
                      Use this when your provider does not support
                      the ListBuckets API (e.g. Cloudflare R2).
                      Example: my-bucket,other-bucket
