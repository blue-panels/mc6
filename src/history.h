...
#define MC_HISTORY_FM_PANELIZE_LABEL  "mc.fm.panelize.label"
#define MC_HISTORY_FM_PANELIZE_CMD    "mc.fm.panelize.cmd"
...
#define MC_HISTORY_FM_MENU_IMPORT     "mc.fm.menu.import"
