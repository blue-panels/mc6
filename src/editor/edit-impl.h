...
off_t edit_line_bol (WEdit *edit, off_t pos);
off_t edit_get_line_eol (WEdit *edit, off_t bol);
off_t edit_get_current_eol (WEdit *edit);
off_t edit_line_next_offset (WEdit *edit, off_t b);
...
void edit_show_control_chars_cmd (WDialog *h);
